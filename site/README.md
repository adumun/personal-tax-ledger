...
- GitHub Releases: aún no existe un release publicado y no debe presentarse como canal canónico actual;
- Microsoft Store: lane separada; la última evidencia canónica registra `0.1.5.0` como submitted / certification pending, no como release publicado;
